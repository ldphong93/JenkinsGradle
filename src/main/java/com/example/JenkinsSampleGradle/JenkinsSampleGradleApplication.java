package com.example.JenkinsSampleGradle;
...
public class JenkinsSampleGradleApplication {

	public static void main(String[] args) {
		SpringApplication.run(JenkinsSampleGradleApplication.class, args);
	}
	...
	public CommandLineRunner sampleData(ThemeParkRideRepository repository) {
		return (args) -> {
			repository.save(
					new ThemeParkRide("Rollercoaster", "Train ride that speeds you along.", 5, 3));
